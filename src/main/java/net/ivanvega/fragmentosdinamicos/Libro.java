...
public class Libro {
    ...
    static{
        ...
        libros.add(new Libro("Divina Comedia", "Dante", R.drawable.divina_comedia, SERVIDOR + "divinacomedia_1501_librivox/divinacomedia_001_alighieri_128kb.mp3", Libro.G_EPICO, true, false));
        ...
        libros.add(new Libro("La iliada", "Homero", R.drawable.la_iliada, SERVIDOR + "iliada_1505_librivox/iliada_01_homero_128kb.mp3", Libro.G_EPICO, true, false));
    }
